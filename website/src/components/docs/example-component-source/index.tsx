...
import { ComponentSourceClient } from "@/components/docs/component-source/client/index";
import { DynamicCodeBlock } from "fumadocs-ui/components/dynamic-codeblock";

const R2_BASE_URL =
  "https://pub-9197ce7f777e4624837aafbc57c580a2.r2.dev/react-native-usage";
...
export async function ExampleComponentSource({
  name,
  src,
  code,
  lang = "tsx",
  ...
  // Priority 3: Fetch source from R2 bucket
    ...
    try {
      ...
      console.error("Error fetching example source:", error);
    }
  }
